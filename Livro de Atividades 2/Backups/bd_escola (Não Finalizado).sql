...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/06/2026 às 14:44
...
--
ALTER TABLE `responsaveisalunos`
  ADD CONSTRAINT `responsaveisalunos_ibfk_1` FOREIGN KEY (`idAluno`) REFERENCES `alunos` (`idAlunos`),
  ADD CONSTRAINT `responsaveisalunos_ibfk_2` FOREIGN KEY (`idResponsavel`) REFERENCES `responsaveis` (`idResponsavel`);
COMMIT;
